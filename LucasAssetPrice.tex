...
(See \href{https://econ-ark.org/materials/LucasAssetPrice?launch}{LucasAssetPrice} for a notebook that solves the model numerically).
...
\end{aligned}\end{gathered}\end{equation}
\end{verbatimwrite}
\input{./Equations/LAP_StochDiscFact.tex}
...
\end{aligned}\end{gathered}\end{equation}
\end{verbatimwrite}
\input{./Equations/LAP_PtsubPtp1.tex}
...
\end{aligned}\end{gathered}\end{equation}
\end{verbatimwrite}
\input{./Equations/LAP_PtAsPDV.tex}
...
\end{aligned}\end{gathered}\end{equation}
\end{verbatimwrite}
\input{./Equations/LAP_pofdCRRA.tex}
...
\end{aligned}\end{gathered}\end{equation*}
\end{verbatimwrite}
\input{./Equations/LAP_pofdLog.tex}
...
\end{aligned}\end{gathered}\end{equation}
\end{verbatimwrite}
\input{./Equations/LAP_pWithLogU.tex}
...
\end{aligned}\end{gathered}\end{equation}
\end{verbatimwrite}
\input{./Equations/LAP_PtLogIID.tex}
...
\end{aligned}\end{gathered}\end{equation}
\end{verbatimwrite}
\input{./Equations/LAP_pofdCRRAWdvdndGro.tex}
...
\end{aligned}\end{gathered}\end{equation}
\end{verbatimwrite}
\input{./Equations/LAP_pofdCRRAIsConst.tex}
...
% \end{aligned}\end{gathered}\end{equation}
% \end{verbatimwrite}
% \input{./Equations/LAP_PtLogRW.tex}
